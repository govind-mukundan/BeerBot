...
#define glcd_CHIP2  glcdCSEL1,LOW,  glcdCSEL2,HIGH
 ...
 */
//                 BLpin    on   off
#define glcd_BLctl glcdBL, HIGH, LOW
...
#elif defined(CORE_TEENSY)		// Teensy
#include "config/ks0108_Teensy.h"	// config for Teensy and Teensy++  
#elif defined(__AVR_ATmega32U4__)
#include "config/ks0108_Leonardo.h"	// config for Leonardo
//#include "config/ks0108_Leonardo_govind.h"	// config for Leonardo
#else
